...
<?php echo $this->Form->create('Vorteil');?>
	<fieldset>
		<legend><?php echo __('Edit Vorteil'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Vorteil.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Vorteil.id'))); ?></li>

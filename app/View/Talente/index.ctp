<div class="talente index">
	<h2><?php echo __('Talente');?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id');?></th>
			<th><?php echo $this->Paginator->sort('name');?></th>
			<th><?php echo $this->Paginator->sort('sprachkomplexitaet');?></th>
			...
			<th><?php echo $this->Paginator->sort('talentart_id');?></th>
	...
	<tr>
		...
		<td><?php echo h($talent['Talent']['name']); ?>&nbsp;</td>
		<td><?php echo h($talent['Talent']['sprachkomplexitaet']); ?>&nbsp;</td>
		<td>

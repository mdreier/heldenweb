...
<?php echo $this->Form->create('Held');?>
	<fieldset>
		<legend><?php echo __('Edit Held'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Held.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Held.id'))); ?></li>

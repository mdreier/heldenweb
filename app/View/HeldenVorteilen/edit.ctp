...
<?php echo $this->Form->create('HeldenVorteil');?>
	<fieldset>
		<legend><?php echo __('Edit Helden Vorteil'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HeldenVorteil.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('HeldenVorteil.id'))); ?></li>

...
<?php echo $this->Form->create('Sonderfertigkeit');?>
	<fieldset>
		<legend><?php echo __('Edit Sonderfertigkeit'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Sonderfertigkeit.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Sonderfertigkeit.id'))); ?></li>

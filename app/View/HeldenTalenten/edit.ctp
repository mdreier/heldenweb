...
<?php echo $this->Form->create('HeldenTalent');?>
	<fieldset>
		<legend><?php echo __('Edit Helden Talent'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HeldenTalent.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('HeldenTalent.id'))); ?></li>

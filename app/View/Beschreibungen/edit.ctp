...
<?php echo $this->Form->create('Beschreibung');?>
	<fieldset>
		<legend><?php echo __('Edit Beschreibung'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Beschreibung.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Beschreibung.id'))); ?></li>
